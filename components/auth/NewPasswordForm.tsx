        ...
        <div className="hidden lg:flex flex-col justify-center px-12 xl:px-20 text-white relative z-10">
          <div className="max-w-lg">
            ...
            <p className="text-xl text-green-100 mb-8 leading-relaxed">
              Create a strong password to protect your farming data and continue
              your journey with cutting-edge agricultural technology.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: KeyRound, text: "Advanced password protection" },
                { icon: Lock, text: "Secure data transmission" },
              ].map((feature, index) => (
                <div
                  key={index}
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-green-200">
                  Enter a new password to secure your AgroVision account
                </p>
              </div>
