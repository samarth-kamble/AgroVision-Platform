        ...
        <div className="hidden lg:flex flex-col justify-center px-12 xl:px-20 text-white relative z-10">
          <div className="max-w-lg">
            ...
            <p className="text-xl text-green-100 mb-8 leading-relaxed">
              Start your journey with cutting-edge agricultural technology.
              Connect with thousands of farmers worldwide and transform your
              farming with AI-powered insights.
            </p>

            {/* Feature List */}
            <div className="space-y-4">
              {[
                { icon: Zap, text: "AI-powered crop analytics" },
                { icon: Sun, text: "Smart weather predictions" },
                { icon: Leaf, text: "Sustainable farming guides" },
                { icon: UserPlus, text: "Global farming community" },
              ].map((feature, index) => (
                <div
                  key={index}
            ...
            <div className="mt-8 pt-8 border-t border-green-500/20">
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-green-200">Yield Increase</div>
                </div>
                <div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
                  ...
                  >
                    <span className="relative z-10 flex items-center justify-center gap-3">
                      {isPending ? (
                        ...
                        <>
                          <span>Join AgroVision Community</span>
              ...
              <div className="text-center mt-8 pt-6 border-t border-white/20">
                <p className="text-green-200 mb-4">Already have an account?</p>
                <Link
                  href="/auth/login"
                ...
                >
                  <span>Sign In to AgroVision</span>
